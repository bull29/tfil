--[[
	Despite my method offering a 35 - 60% performance boost, override functions that are accessed through [C] such as Entity.RenderOverride don't work if I enable this. :(
]]
