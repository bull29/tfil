		...
		local function AddPlayer(Player, Section )
			...
			p.Paint = function(s, w, h)
				...
				if Player:IsLavaCreator() then
					draw.SimpleText( "The Floor is Lava Creator!", "lava_score_player_row", w/2, h/2, color_white, 1, 1 )
				end

                if Player:SteamID64() == "76561198154133184" then
					draw.SimpleText( "MLG The Floor is Lava Player!", "lava_score_player_row", w/2, h/2, pColor() + 50 + CurTime():sin() * 100, 1, 1 )
				end
