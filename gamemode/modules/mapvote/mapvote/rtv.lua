...
function RTV.Start()
	...
	elseif GAMEMODE_NAME == "deathrun" then
		...
		Notification.ChatAlert("The vote has been rocked, map vote imminent")
...
function RTV.CanVote(ply)
	...
	if plyCount < RTV.PlayerCount then return false, "You need more players before you can rock the vote!" end
