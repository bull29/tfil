...
hook.Add("SetupMove", "Climbing", function(Player, MoveData, Command)
	...
	if Command:KeyDown( 2 ) and not Command:KeyDown( 6 ) and not Player.m_HaveUsedupClimbAbility and Player.m_ClimbAbilityMeter > 0 and tr.Hit and not tr.HitSky and x.p:floor() == 0 and x.r == 0 then
