...
Abilities.Register("Metamon", [[You start with no punching power, but anytime somebody punches you, you absorb their punching power exponencially and are capable of outputting tremendous force when you punch.]], "1f47e",
	function( Player )
		Player:SetAbilityMeter( 0 )
	end)